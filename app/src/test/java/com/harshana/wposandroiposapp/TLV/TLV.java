package com.harshana.wposandroiposapp.TLV;
...
public class TLV {
    ...
    public static String makePol(DolItem[] pols, HashMap<String, String> map) {
        ...
        for(int var4 = 0; var4 < var5; ++var4) {
            ...
            System.out.println("POL:" + d.tag + " " + r + " //" + nameMap.get(d.tag));
            if(r == null) {
    ...
    public static String makeLinkPinOK(String s) {
        ...
        for(int i = 0; i < s.length() - 3; i += 4) {
            ...
            byte[] bs = Utility.hexStr2Byte(sub);
            if((bs[0] & 63) == 2) {
                return sub + "00";
            }
        }
    ...
    public byte[] getBytesValue() {
        ...
        int l = getLength();
        Log.i(TAG, "getBytesValue: data:"+ BytesUtil.bytes2HexString(data));
    ...
    private static byte[] makeLengthData2(int len) {
        ...
        if (len > 127) {
            ...
            Log.i(TAG, "makeLengthData: lenData::"+BytesUtil.bytes2HexString(lenData));
            return lenData;
        }
